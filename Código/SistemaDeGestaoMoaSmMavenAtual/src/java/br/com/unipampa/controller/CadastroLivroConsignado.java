 ...
 */
@WebServlet(name = "CadastroLivroConsignado", urlPatterns = {"/CadastroLivroConsignado"})
public class CadastroLivroConsignado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (itemConsignado.cadastrarItem(itemConsignado)) {
            ...
            try {
                ...
                while (iterador.hasNext()) {
                    ...
                    if (item.getName().contains(".jpeg") == true || item.getName().contains(".jpg")) {
                        if (UploadDeArquivo.processarArquivo(path, item, itemConsignado.getOutroCodigo()+".jpg")) {
