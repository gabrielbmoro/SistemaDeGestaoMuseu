        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
        <h1>Registro de Item em Acervo</h1>
        <%
            Object envioDeArquivo = request.getSession().getAttribute("envioDeArquivo");
            if (envioDeArquivo instanceof Boolean) {
                boolean envioDeArquivoBoolean = (Boolean) envioDeArquivo;
                if (envioDeArquivoBoolean) {
                    ...
                    out.println("<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times;</button>");
                    out.println("Por favor, realize a operação novamente!");
                    out.println("</div>");
                    out.println("</div>");
                    out.println("</div>");
                }
