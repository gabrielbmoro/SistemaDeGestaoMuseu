...
<html lang="en">
    ...
    <head>
        ...
        <script src="script/validaFormularioCadastroDeUsuario.js" type="text/javascript"></script>
        <!-- Custom Fonts -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <form id="cadastroDeUsuario" method="POST" action="./CadastroDeUsuario">
                                    ...
                                    <div class="col-lg-12">
                                        <div >
                                            <h3> Formulário de Cadastro De Usuários</h3>
                                                <br />
                                                <label>Nome:</label> 
                                                <input class="form-control" type="text" required name="nome" ><br />
                                                <label>CPF:</label> 
                                                <input class="form-control" type="number" required name="cpf"><br />
                                                <label>Endereço:</label> 
                                                <input  class="form-control" type="text" required name="endereco"><br />
                                                <label>Login:</label> 
                                                <input class="form-control" type="text" required name="login"><br />
                                                <label>Senha:</label> 
                                                <input class="form-control" type="password" required id= "senha" name="senha"><br />
                                                <label>Repita a Senha:</label> 
                                                <input class="form-control" type="password" required id= "senha1" name="senha1"><br />
                                              <!--  <input class="btn btn-primary" type="submit" value="Salvar"> <br />!-->
                                              <button class="btn-primary" onclick="enviarFormularioDeUsuario()">Registrar Dados</button>
