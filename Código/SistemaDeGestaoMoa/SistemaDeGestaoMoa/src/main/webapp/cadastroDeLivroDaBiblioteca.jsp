<%-- 
    Document   : cadastroDeLivroDaBiblioteca
    Created on : 18/05/2015, 21:39:58
    Author     : gabrielbmoro
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                             <!--method="POST" action="./CadastroLivroDaBiblioteca"-->
                            <form id="cadastrarLivro" method="POST" action="./CadastroLivroDaBiblioteca">
                                <div class="form-group">
                                    <div class="col-lg-10">
                                        <div >
                                            ...
                                            <input class="form-control" type="text" name="tituloLivro" /> <br />


                                            <label>Autor do Livro: </label><br />
                                            <input class="form-control" type="text" name="autorLivro" /><br />
                                            <label>Grafica de Impressão do Livro: </label> <br />
                                            <input class="form-control" type="text" name="grafica" /><br />
                                            <label>Ano de Publicação: </label><br />
                                            <input class="form-control" type="text" name="ano" /><br />
