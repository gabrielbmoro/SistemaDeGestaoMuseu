<%-- 
    Document   : cadastroDeLivroConsignado
    Created on : 27/04/2015, 16:00:03
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form name="form" method="POST" action="./CadastroLivroConsignado" >
                                <div class="form-group">
                                    <div class="col-lg-10">
                                        <div >
                                            ...
                                            <input class="form-control" type="date" name="dataDoEmprestimo" required="required" maxlength="10"  pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" min="2012-01-01" max="2017-02-18" /><br />
                                            
                                            <label>Data de Devolução: </label> <br />
                                            <input class="form-control"  name="dataDeDevolucao" type="date" required="required" maxlength="10"  pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" min="2012-01-01" max="2017-02-18"/><br />
                                            
                                            <label>Responsavel da Familia: </label><br />
                                            <input class="form-control" type="text" name="responsavelDaFamilia" /><br />
                                            ...
                                            <input class="form-control" type="text" name="funcaoEspecifica" /><br />
                                            <label>Cultura: </label><br />
                                            <input class="form-control" type="text" name="cultura" /><br />
                                        </div>
                                        <div>
                                            <label>Estilo: </label><br />
                                            <input class="form-control" type="text" name="estilo" /><br />
                                            <label>Grupo Linguístico: </label><br />
                                            <input class="form-control" type="text" name="procedencia" /><br />
                                            <label>Técnica Manufatura: </label><br />
                                            <input class="form-control" type="text" name="tecnicaManufatura" /><br />
                                            <label>Procedência: </label><br />
                                            <input class="form-control" type="text" name="procedencia" /><br />
                                            <label>Região: </label><br />
                                            <input class="form-control" type="text" name="regiao" /><br />
                                            <label>Sitio: </label><br />
                                            <input class="form-control" type="text" name="sitio" /><br />
